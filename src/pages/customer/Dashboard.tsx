...
const CustomerDashboard: React.FC = () => {
  const { userCards, userTransactions, portalNotices } = useCreditCard();
  ...
  const filteredTransactions = selectedCard === 'overall'
    ? userTransactions
    : userTransactions.filter(tx => tx.cardId === selectedCard);

  // Calculate overall credit stats
  const overallStats = userCards.reduce((acc, card) => ({
                    ...
                    >
                      <div className="flex justify-between items-center">
                        ...
                        <Button
                          ...
                          rightIcon={expandedCards.includes(card.id) ? <ChevronUp size={16} /> : <ChevronDown size={16} />}
                        >
